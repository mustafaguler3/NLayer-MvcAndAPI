...
namespace NLayer.Service.Services
{
    public class CategoryService : Service<Category>, ICategoryService
    {
        ...
        public CategoryService(IGenericRepository<Category> repository, IUnitOfWork uow, IMapper mapper, ICategoryRepository categoryRepository) : base(repository, uow)
        {
            _mapper = mapper;
